...
/**
 * /tests/Integration/Rest/Traits/Actions/User/ActionTest.php
 *
 ...
 * Class ActionTest
 *
 * @package App\Tests\Integration\Rest\Traits\Actions\User
 * @author TLe, Tarmo Leppänen <tarmo.leppanen@protacon.com>
 */
class ActionTest extends KernelTestCase
{
    ...
    public function dataProviderTestThatTraitCallsExpectedMethod(): array
    {
        ...
        $folder = static::$kernel->getProjectDir() . '/src/Rest/Traits/Actions/User/';
        $pattern = '/^.+\.php$/i';
