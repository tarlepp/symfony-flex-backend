...
FROM php:8.5.7-fpm-bookworm@sha256:8971d7dee33749d35c98ae465bfa769346961151a8c24a0a41c9713fcbc1f521
...
COPY --from=mlocati/php-extension-installer:2.11.11 /usr/bin/install-php-extensions /usr/local/bin/
