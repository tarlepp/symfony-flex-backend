 ...
 */
final class Version20201227112248 extends AbstractMigration
{
    /**
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE date_dimension (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', date DATE NOT NULL, year INT NOT NULL COMMENT \'A full numeric representation of a year, 4 digits\', month INT NOT NULL COMMENT \'Day of the month without leading zeros; 1 to 12\', day INT NOT NULL COMMENT \'Day of the month without leading zeros; 1 to 31\', quarter INT NOT NULL COMMENT \'Calendar quarter; 1, 2, 3 or 4\', week_number INT NOT NULL COMMENT \'ISO-8601 week number of year, weeks starting on Monday\', day_number_of_week INT NOT NULL COMMENT \'ISO-8601 numeric representation of the day of the week; 1 (for Monday) to 7 (for Sunday)\', day_number_of_year INT NOT NULL COMMENT \'The day of the year (starting from 0); 0 through 365\', leap_year TINYINT(1) NOT NULL COMMENT \'Whether it\'\'s a leap year\', week_numbering_year INT NOT NULL COMMENT \'ISO-8601 week-numbering year.\', unix_time BIGINT NOT NULL COMMENT \'Seconds since the Unix Epoch (January 1 1970 00:00:00 GMT)\', INDEX date (date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE healthz (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', timestamp DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE log_login (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', user_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', type ENUM(\'failure\', \'success\') NOT NULL COMMENT \'(DC2Type:EnumLogLogin)\', client_type VARCHAR(255) DEFAULT NULL, client_name VARCHAR(255) DEFAULT NULL, client_short_name VARCHAR(255) DEFAULT NULL, client_version VARCHAR(255) DEFAULT NULL, client_engine VARCHAR(255) DEFAULT NULL, os_name VARCHAR(255) DEFAULT NULL, os_short_name VARCHAR(255) DEFAULT NULL, os_version VARCHAR(255) DEFAULT NULL, os_platform VARCHAR(255) DEFAULT NULL, device_name VARCHAR(255) DEFAULT NULL, brand_name VARCHAR(255) DEFAULT NULL, model VARCHAR(255) DEFAULT NULL, time DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', `date` DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', agent LONGTEXT NOT NULL, http_host VARCHAR(255) NOT NULL, client_ip VARCHAR(255) NOT NULL, INDEX user_id (user_id), INDEX date (date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_group (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', role VARCHAR(255) DEFAULT NULL, created_by_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', updated_by_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_8F02BF9D57698A6A (role), INDEX IDX_8F02BF9DB03A8386 (created_by_id), INDEX IDX_8F02BF9D896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
